...
public class JLabelBala extends JLabel {
	...
	public static final int TAMANYO_BALA= 40;  // píxels (igual alto que algo)
	public static final int ANCHURA_BALA= 40;  // píxels (igual ancho que algo)
	public static final int RADIO_ESFERA_BALA= 20;  // Radio en píxels del bounding circle del prota (para golpes)
	...
	public JLabelBala() {
		try {
			setIcon( new ImageIcon( JLabelBala.class.getResource( "bala.png" ).toURI().toURL() ) );
		} catch (Exception e) {
